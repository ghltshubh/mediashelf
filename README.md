...
| [Browser extension](https://github.com/ghltshubh/mediashelf-clipper/releases/latest) | copies your "My List" over from Netflix, Prime Video, Disney+ and 7 more | separate install |
